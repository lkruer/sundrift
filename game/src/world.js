...
import { ASSET } from '../assetlib.js?v=202609242050';
import { surface } from '../surfaces.js?v=202609242050';
import { PAL, clamp, lerp, smoothstep, mulberry32 } from './config.js?v=202609242050';
import { Ground } from './ground.js?v=202609242050';
import { Terrain, LODS } from './terrain.js?v=202609242050';
import { partsOf, Pool, freezeStatic } from './instancing.js?v=202609242050';
...
vec2 roadUv(vec2 uv) {
  ...
  loadCity() {
    if (!this._cityLoad) this._cityLoad = (async () => {
      try {
        const City = await import('./city.js?v=202609242050');
        this._cityMats = City.cityLoad(this, Pool, '"M PLUS Rounded 1c", "Dela Gothic One", "Noto Sans JP", "Hiragino Sans", "Yu Gothic", sans-serif');
        const L = await import('./landmarks.js?v=202609242050').catch((e) => { console.warn('landmarks', e && e.message); return null; });
