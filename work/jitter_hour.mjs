...
await new Promise((r) => setTimeout(r, 900)); await page.click('#startb'); if (process.env.HOUR) await page.evaluate((h) => { window.__DEBUG__.G.hour = Number(h); }, process.env.HOUR);
await page.evaluate(() => {
