...
await page.tracing.start({ path: 'work/shots/trace.json', categories: ['devtools.timeline', 'v8', 'disabled-by-default-devtools.timeline', 'blink.user_timing', 'v8.execute'] });
